...
<% String sidd=(String)request.getAttribute("chk");%>
<input type="hidden" name="scid"  value="<%=sidd%>" >
	
<form method="post" action="/ecommerce/UpdateCourse">

<table border="4"style="font-size: 17px;padding:15px">

<tr><th>Scheduled id<sup >*</sup></th><td><%=sidd %></td></tr>
...
<tr><th colspan="2" ><br><button style="width:200px;background-color: orange" value="submit" >Update course</button></th>
