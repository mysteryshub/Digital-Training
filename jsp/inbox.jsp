...
<form  method="post" action="/ecommerce/Inbox" >
...
{%>
<p  align="center" style="font-size:30px;color:black;position: absolute;margin-top: 130px;margin-left: 230px"><b>INBOX</b></p>
...
<tr style="color:black;font-size: 20px"><th>Select</th><th>Sender id</th><th>Subject</th><th>Date</th></tr>
<%
ResultSet rs=null;
Connection con=null;
PreparedStatement ps=null;
String strsql="select * from message where recieverid=? and rstatus=? ";
